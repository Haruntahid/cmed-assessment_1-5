...
public class ServerResponse {
    ...
    public static ResponseEntity<ResponseData> withData(String message, Object data) {
    ...
    public static <T> ResponseEntity<ResponseData> withPaginatedData(String message, Page<T> pageData) {
        return ResponseEntity.ok().body(
                new ResponseData(
                        HttpStatus.OK.value(),
                        "Success",
