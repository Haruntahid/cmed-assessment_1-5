...
function CreatePrescription() {
  ...
  const {
    ...
    reset,
    formState: { errors },
    setValue, // Use setValue to set default value
  } = useForm();
  ...
  // Set the default value for prescriptionDate using setValue
  setValue("prescriptionDate", todayFormatted);

  const onSubmit = (data) => {
    console.log("Form Data:", data);

    axios
      .post("http://localhost:8080/api/v1/prescription", data, {
        headers: {
